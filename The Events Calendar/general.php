...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	 ...
	 * @return string
	 */
	function tribe_event_featured_image( $post_id = null, $link = true/*, $wrapper = true */) {
		if ( is_null( $post_id ) ) {
			$post_id = get_the_ID();
		}
		 ...
		 * @param int    $post_id
		 */
//		$size = apply_filters( 'tribe_event_featured_image_size' $post_id );
...
//		}
		 ...
		 * @param bool $wrapper
		 */
		if ( ! empty( $featured_image ) /*&& apply_filters( 'tribe_events_featured_image_wrap') */) {
			$featured_image = "<div class='tribe-events-event-image' style='background-image: url($featured_image)'></div>";  
		}
